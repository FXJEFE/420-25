...
def main():
    ...
    # NEVER overwrite OG my_model.pkl — write a timestamped copy under og333_runs/
    from fxjefe_paths import safe_model_out_path, assert_not_og_model
    model_path = safe_model_out_path(config, 'my_model.pkl')
